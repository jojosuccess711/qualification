...
/**
  * @className ChineseNameUtils
  * @description Email 手机号 中文地址 中文名字生成工具类
  * @author dbc
  * @date 2019/10/11
  * @version 1.0
  **/
public final class ChineseNameUtils {
    ...
    public static String getChineseNamePrivate() {
        String chineseName = getChineseName();
        return chineseName.substring(0, chineseName.length() - 1) + "*";
    }

    private static String[] moneys = "10,20,30,50,100".split(",");

    public static String getMoneyRMB() {
        int index = getNum(0, moneys.length - 1);
        String first = moneys[index];
        return first + "元";
    }
}
