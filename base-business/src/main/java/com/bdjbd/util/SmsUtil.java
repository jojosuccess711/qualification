...
public class SmsUtil {
    ...
    //智能匹配模板发送接口的http地址
    private static String URI_BATCH_SEND_SMS =
    ...
    public static void main(String[] args) throws IOException,
        ...
        String apikey = "4138e5bf2cdae7f2d9cbbb392b8fa477";

        //修改为您要发送的手机号
        String mobile = "13522167503";
        ...
        String tpl_value = URLEncoder.encode("#code#", ENCODING) + "=" +
                ...
                "#company#", ENCODING) + "=" + URLEncoder.encode("诺维北斗",
                ENCODING);
        //模板发送的调用示例
        System.out.println(tpl_value);
        System.out.println(SmsUtil.tplSendSms(apikey, tpl_id, tpl_value,
                mobile));
    ...
    public static String batchSendSms(String apikey, String text,
                                      String mobile) {
        if (org.apache.commons.lang3.StringUtils.isNotBlank(apikey) &&
                org.apache.commons.lang3.StringUtils.isNotBlank(text) &&
                org.apache.commons.lang3.StringUtils.isNotBlank(mobile)) {
            Map<String, String> params = new HashMap<>();
            params.put("apikey", apikey);
            params.put("text", text);
            params.put("mobile", mobile);
