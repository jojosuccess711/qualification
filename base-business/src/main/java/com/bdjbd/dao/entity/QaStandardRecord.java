/**
 * @filename:QaStandardRecord 2020/02/20
 * @project BDJBD  V1.0
...
/**
 *
 * @Description: 用户标准信息记录表
 * @Author: DBC
 * @CreateDate: 2020/02/20
 * @Version: V1.0
 *
 */
@Table(name = "qa_standard_record")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class QaStandardRecord implements Serializable {
    ...
    @ApiModelProperty(name = "categoryTitle", value = "现职称")
    ...
    /** 记录项按序号分组整理 */
    @Transient
    private List<RecordItemGroup> itemGroups;

    @Transient
    private List<QaStandardRecordItem> items;

    @Column(name = "commit_status")
    @ApiModelProperty(name = "commitStatus", value = "提交状态")
