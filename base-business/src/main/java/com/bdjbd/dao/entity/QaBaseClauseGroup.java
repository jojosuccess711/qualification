/**
 * @filename:QaBaseClauseGroup 2020/02/20
 * @project BDJBD  V1.0
 ...
 *    
 */
@Table(name = "qa_base_clause_group")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class QaBaseClauseGroup implements Serializable {
	...
	@Transient
	private List<QaBaseClause> clauseList;
